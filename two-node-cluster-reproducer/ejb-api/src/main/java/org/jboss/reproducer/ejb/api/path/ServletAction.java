...
public class ServletAction implements Action {
    ...
    /* (non-Javadoc)
     * @see org.jboss.reproducer.ejb.api.path.Action#invoke(org.jboss.reproducer.ejb.api.EJBRequest)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see org.jboss.reproducer.ejb.api.path.Action#isWorkflowAction()
     */
    @Override
